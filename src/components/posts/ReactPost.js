...
export default function ReactOnPost() {
  ...
  return (
    ...
    <div className="postReactions mb-3">
      ...
      <Form onSubmit={handleSubmit(submitReact)} className="reactPost__form">
        {updated && <SuccessMessage>Reaction posted!</SuccessMessage>}
        {reactOnPostError && <DisplayError>{reactOnPostError}</DisplayError>}
        ...
        >
          <option value="" className="reactPostForm__select">
            Your reaction
          </option>
          <option>&#128525;</option>
          <option>&#128077;</option>
        ...
        {errors.symbol && <DisplayError>{errors.symbol.message}</DisplayError>}
        <button
          type="submit"
          className="reactPost--button"
        >
          React Post
        </button>
